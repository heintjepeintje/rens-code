...
: ${AMENT_CURRENT_PREFIX:="/home/hein/dev/ros-test/install/test-package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test-package/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/test-package/environment/path.sh"
